...
//   {/* Spinner Wrapper */}
//   <div className='relative flex items-center justify-center w-45 h-45'> {/* বড় এবং content অনুযায়ী tight */}

//     {/* Outer Gray Ring */}
//     <svg className='absolute inset-0 w-full h-full' viewBox='0 0 100 100'>
//       <circle cx='50' cy='50' r='45' fill='none' stroke='#E4E6EB' strokeWidth='4' />
//     </svg>

//     {/* Outer Blue Ring - Animated */}
//     <svg 
...
//     {/* Inner Gray Ring */}
//     <svg className='absolute inset-0 w-full h-full' viewBox='0 0 100 100'>
//       <circle cx='50' cy='50' r='45' fill='none' stroke='#E4E6EB' strokeWidth='4' strokeOpacity='0.3' />
//     </svg>

//     {/* Inner Blue Ring - Reverse */}
//     <svg 
//       className='absolute inset-0 w-full h-full animate-spin' 
...
//       {/* Logo Container */}
//       <div className='relative w-36 h-36 rounded-full overflow-hidden bg-gradient-to-br from-blue-500 to-blue-600 shadow-md flex items-center justify-center'>
...
export default function PagePreloader() {
    ...
    <div className='relative z-10 flex flex-col items-center'>
        <div className='relative w-56 h-56 flex items-center justify-center'>
            ...
            <div className="absolute inset-0 rounded-full border-gray-100" />

            {/* 2. Outer Gradient Glow */}
            <div
                className='absolute inset-0 rounded-full border-t-2 border-primary/30 animate-spin'
            ...
            <div className='relative flex items-center justify-center z-10'>
                {/* Glow behind logo */}
                <div className="absolute w-44 h-44 rounded-full bg-primary/20 blur-3xl animate-pulse" />
...
//                 {/* Logo Container (border removed) */}
//                 <div className='relative w-30 h-30 rounded-full overflow-hidden bg-gradient-to-br from-blue-500 to-blue-600 shadow-md flex items-center justify-center'>
